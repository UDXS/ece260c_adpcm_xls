...
const int8_t IndexTable[16]={-127,-127,-127,-127,2,4,6,8,-127,-127,-127,-127,2,4,6,8};
...
#pragma hls_top
void ADPCM_Codec(__xls_channel<int16_t>& in_sample, __xls_channel<int16_t>& out_pred) {
  out_pred.write(ADPCM_Decode(ADPCM_Encode(in_sample.read())));
}
